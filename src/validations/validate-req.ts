...
import type { AppActivity, ValidatedReq } from "../types/app.types.js";
...
import {
  ...
  VCustomFieldsArray,
  VCustomFieldVal,
  VCustomFieldValArray,
} from "./schemas/vfields-schema.js";

export async function validateReq<T extends ValidatedReq>(

...
--> statement-breakpoint
ALTER TABLE "contacts_data" ADD CONSTRAINT "contacts_data_contact_id_contacts_id_fk" FOREIGN KEY ("contact_id") REFERENCES "public"."contacts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint

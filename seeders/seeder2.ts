...
const EXTRA_FIELDS_20 = [
  ...
  },
  {
    ...
    generator: () =>
      `$${Math.floor(Math.random() * 100000) + 50000}-$${
        Math.floor(Math.random() * 150000) + 100000
      }`,
  },
  {
    key: "education",
    ...
    type: "text",
    generator: () =>
      ["Bachelor's Degree", "Master's Degree", "PhD", "High School Diploma"][
  ...
  },
  {
    ...
    type: "text",
    generator: () =>
      ["Email", "Phone", "Text", "LinkedIn"][Math.floor(Math.random() * 4)],
  },
  {
    key: "timezone",
    label: "Timezone",
    type: "text",
    generator: () =>
      ["EST", "PST", "CST", "MST", "GMT"][Math.floor(Math.random() * 5)],
  },
  {
    key: "language",
    label: "Language",
...
async function seedContacts() {
  ...
  for (let i = 0; i < totalContacts; i += batchSize) {
    ...
    console.log(
      `Processed batch ${Math.floor(i / batchSize) + 1} (contacts ${
        ...
        contactsDataBatch.length / contactsBatch.length
      } fields per contact`
    );
  }
  ...
  console.log("Summary:");
  console.log(
    "- Contacts 1-10,000: 6 base fields + 10 extra fields = 16 fields each"
  );
  console.log(
    "- Contacts 10,001-30,000: 6 base fields + 20 extra fields = 26 fields each"
  );

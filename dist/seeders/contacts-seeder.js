import { randFirstName, randLastName, randEmail, randAddress, randPhoneNumber, randCompanyName, } from "@ngneat/falso";
...
async function seedContacts() {
    ...
    for (let i = 0; i < totalContacts; i += batchSize) {
        ...
        console.log(`Processed batch ${Math.floor(i / batchSize) + 1} (contacts ${i + 1}-${Math.min(i + batchSize, totalContacts)})`);
    }
